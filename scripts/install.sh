...
# ----
#   curl -sL https://raw.githubusercontent.com/davidnewhall/secspy/master/scripts/install.sh | sudo bash
#   wget -qO- https://raw.githubusercontent.com/davidnewhall/secspy/master/scripts/install.sh | sudo bash
# ----
#
